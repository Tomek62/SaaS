...
export default function FoodCards() {
    return(
        ...
        {foodItems.map((item) => (
          <FoodCard key={item.title} title={item.title} image={item.image} />
        ))}
      </div>
    )
}